          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				...
				<h3>Pricing Modules</h3>
                <ul class="nav side-menu">
					<li><a href="<?= base_url(); ?>categories"><i class="fa fa-sitemap"></i> <span>Categories</span></a></li>
					<li><a href="<?= base_url(); ?>condition"><i class="fa fa-briefcase"></i> <span>Condition</span></a></li>
					<li><a href="<?= base_url(); ?>providers"><i class="fa fa-users"></i> <span>Providers</span></a></li>
					<li><a href="<?= base_url(); ?>storage"><i class="fa fa-check"></i> <span>Storage</span></a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
