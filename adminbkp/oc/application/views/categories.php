                    ...
                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                      <div class="panel">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
						  ...
						  <form class="form-horizontal" method="post" id="Addform" action="<?= base_url();?>Categories/AddRecord">
							<div class="form-group">
								<label class="col-md-2 control-label" for="example-text-input">Category Name</label>
								<div class="col-md-6">
									<input type="text" name="title" value="" placeholder="Enter Category Name" class="form-control">
								</div>
								<div class="col-md-4">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					<form method="post" id="tblform" action="<?= base_url();?>Categories/DeleteRecord">
					  ...
					  ?>
						...
						<input class="chkIds" type="checkbox" name="ids[]" id="chk-<?= $rec['id'] ?>" value="<?= $rec['id'] ?>"  /></td>
                          ...
                          <td>
						   <div class="form-group">
                            <label>
                              <input type="checkbox" class="js-switch"  <?= ($rec['status']==1) ? 'checked' : '' ?> onclick="togglestatus(<?= $rec['id'] ?>,'Categories')" />
                            </label>
                          </div></td>
                          <td>
                          ...
                          <td>
							<a class="btn btn-info btn-sm" href="models?category=<?= $rec['id']; ?>" >Models</a>
							<a class="btn btn-info btn-sm" href="pricing?category=<?= $rec['id']; ?>" >Pricing</a>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
						  <div id="msge"></div>
						  <form class="form-horizontal" method="post" id="Editform" action="<?= base_url();?>Categories/EditRecord">
							<div class="form-group">
