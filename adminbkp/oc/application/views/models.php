                    ...
                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                      <div class="panel">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
						  ...
						  <form class="form-horizontal" method="post" id="Addform" action="<?= base_url();?>Models/AddRecord">
							<div class="form-group">
								<label class="col-md-2 control-label" for="example-text-input">Model Name</label>
								<div class="col-md-6">
									<input type="hidden" name="category_id" value="<?= $category[0]['id']; ?>">
									<input type="text" name="title" value="" placeholder="Enter Model Name" class="form-control">
								</div>
							</div>
							<div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					<form method="post" id="tblform" action="<?= base_url();?>Models/DeleteRecord">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  ?>
						...
						<input class="chkIds" type="checkbox" name="ids[]" id="chk-<?= $rec['id'] ?>" value="<?= $rec['id'] ?>"  /></td>
                          <td><img src="<?=base_url();?>assets/uploads/models/<?= ($rec['image'] != "" ? $rec['image'] : "dummy.png"); ?>"  style="max-height:30px;" /></td>
                          <td><?= $rec['title']; ?></td>
                          <td>
						   <div class="form-group">
                            <label>
                              <input type="checkbox" class="js-switch"  <?= ($rec['status']==1) ? 'checked' : '' ?> onclick="togglestatus(<?= $rec['id'] ?>,'recegories')" />
                            </label>
                          </div></td>
                          <td>
                          ...
                          <td>
							<a class="btn btn-warning btn-edit" data-toggle="modal" data-target="#ModalEdit" data-id="<?= $rec['id']; ?>" data-title="<?= $rec['title']; ?>">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
						  <div id="msge"></div>
						  <form class="form-horizontal" method="post" id="Editform" action="<?= base_url();?>Models/EditRecord">
							<div class="form-group">
								<label class="control-label" for="example-text-input">Model Name</label>
								<input type="text" name="title" id="title" value="" placeholder="Enter Model Name" class="form-control" required>
