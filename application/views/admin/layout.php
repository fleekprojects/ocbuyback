            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
				  ...
				  <li><a><i class="fa fa-cubes"></i>Trades-ins<span class="fa fa-chevron-down"></span></a>
					  <ul class="nav child_menu">
						<li><a href="<?= base_url(); ?>admin/trades">Current Trade-ins</a></li>
						<li><a href="<?= base_url(); ?>admin/passed-trades">Needs Payment</a></li>
						<li><a href="<?= base_url(); ?>admin/past-trades">Past Trade-ins</a></li>
					  </ul>
				  </li>
				</ul>
				<h3>Categories</h3>
                <ul class="nav side-menu">
					<?php
					  ...
					  foreach($side_cat AS $scat){
						echo '<li><a href="'.base_url().'admin/pricing?category='.$scat['id'].'"><i class="fa fa-circle-o"></i> <span>'.$scat['title'].'</span></a></li>';
					  }
					?>
                </ul>
				<h3>Catalog Settings</h3>
                <ul class="nav side-menu">
					<li><a><i class="fa fa-mobile"></i>Models <span class="fa fa-chevron-down"></span></a>
					  <ul class="nav child_menu">
						<?php
						  foreach($side_cat AS $scat){
					...
					<li><a href="<?= base_url(); ?>admin/condition"><i class="fa fa-briefcase"></i> <span>Condition</span></a></li>
					<li><a href="<?= base_url(); ?>admin/providers"><i class="fa fa-users"></i> <span>Providers</span></a></li>
					<li><a href="<?= base_url(); ?>admin/storage"><i class="fa fa-check"></i> <span>Storage</span></a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
